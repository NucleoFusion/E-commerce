    ...
    return (
        <div className="ProfilePage-container">
            ...
            <div className="ProfilePage-card-container">
                <HorizontalCard title='Wishlist' srcImg='./img/icons8-heart-100.png'
            ...
            <div className="address-selector-container">
                ...
                <div className="ProfilePage-AddressForm-container span-col-2">
                    <div className="ProfilePage-button-container">
                        <button type="button" className="btn btn-primary button-define span-col-2 addAddress-button" onClick={showForm}>Add Address</button>
                        <button type="button" className="btn btn-primary close-button button-define" onClick={toggleDropdown} style={{display:'none'}}>Close</button>
                    </div>
